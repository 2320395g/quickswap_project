...
def run_query(search_terms):
	...
	#TOODO: make the function handle "network errors", whatever they are, better
	if not search_terms or search_terms == "":
		raise IOError('no search terms provided')
...
def main():
	results = run_query(input("Please insert search terms: "))
	for r in results:
