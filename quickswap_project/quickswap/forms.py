...
from quickswap.models import Page, Category, UserProfile, Trade, Comment, Pictures
...
class TradeForm(forms.ModelForm):
    ...
    #picture = forms.ImageField(help_text="Please select an image of the object you would like to trade.")
